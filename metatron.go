...
func main() {
	...
	fmt.Printf("✅ CONCLUÍDO] Todos os resultados estão em: %s\n", outputDir)
	logMessage(fmt.Sprintf("✅ Resultados salvos em: %s", xssPath))
	logMessage(fmt.Sprintf("✅ CONCLUÍDO] Todos os resultados estão em: %s", outputDir))
}
